...
# ITP 115, Summer 2022
# Section: 31810
# Assignment 8: defining and calling functions with a helper file
...
def playGame():
    ...
    while winner == "n":  # continue the game
        TicTacToeHelper.printUglyBoard(boardList)  # display the board to the user
        ...
        winner = TicTacToeHelper.checkForWinner(boardList, moveCounter)  # check whether there is a winner by calling checkForWinner() and update the result into winner
        moveCounter += 1  # add 1 to the number of moves
    TicTacToeHelper.printUglyBoard(boardList)  # display the final board
